...
router.patch('/:productCode/lost', adminOnly, (req, res) => productController.markProductAsLost(req, res));

// PATCH: marcar un producto como encontrado (se envía a revisión)
router.patch('/:productCode/found', adminOnly, (req, res) => productController.markProductAsFound(req, res));
