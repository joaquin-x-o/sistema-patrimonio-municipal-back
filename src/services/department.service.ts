...
export class DepartmentService {
    ...
    async updateDepartment(departmentCode: string, dto: UpdateDepartmentDto): Promise<DepartmentResponseDto> {
        ...
        // CREACION DEL DEPARTAMENTO OPR ACTUALIZAR
        Object.assign(currentDepartment, dto);

        // ACTUALIZACION DEL DEPARTAMENTO
        await this.departmentRepository.updateDepartment(currentDepartment);

        return mapToDtoResponse(DepartmentResponseDto, currentDepartment)
    }
