...
export class Department {
    ...
    // Department - RetirementHistory: Un departamento puede estar en el reporte de bajas de uno o más productos
    @OneToMany(() => RetirementHistory, (history) => history.department)
    retirementReport!: RetirementHistory[];
